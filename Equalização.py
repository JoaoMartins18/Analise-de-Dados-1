...
with open('ITM-22-111-Am-05-CBI22-077-EQUALIZACAO_4X_C20-_trocou-de-circuito_-_Final-05-01-23_.csv', 'r') as arquivo_csv:

    # Lê o arquivo CSV
    leitor_csv = pd.read_csv('ITM-22-111-Am-05-CBI22-077-EQUALIZACAO_4X_C20-_trocou-de-circuito_-_Final-05-01-23_.csv', sep=',', on_bad_lines='skip', low_memory=False)
...
conexao = sqlite3.connect('Equalização_AM05.db')
